...
While \cite{Hollyer2014} consider how voters might react when they get data, there is a separate literature that focuses on how voters react, and in particular whether signals they receive from economic data about the competence of the government in managing economic policy.\todo{I was confused by this sentence.} One debate considers whether voters are prospective or retrospective. On the latter, the assumption is that voters observe outcomes, and they decide whether to support the incumbent government. There is a growing literature on ``real-time fiscal policy''. \cite{kayser_peress} find that...
...
\cite{DeCastro2013} \todo[inline]{This is a crucial piece as it does the revisions/elections timing research that we basically just replicate.}
...
\input{tables/finstress_predict_endog.tex}
