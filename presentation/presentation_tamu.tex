...
\frame{
    \frametitle{High FinStress/Endogenous elections examples}
    ...
    \begin{itemize}
        \item Italy (2008)
            ...
            \begin{itemize}
                ...
                \item Cum. debt revision: 0.4 (\% GDP)
            \end{itemize}
        ...
        \begin{itemize}
            ...
            \item Cum. debt revision: 11.3 (\% GDP)
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item Cum. debt revision: 6.4 (\% GDP)
        \end{itemize}
...
\frame{
    ...
    Extend FinStress through present to extend sample.
...
\frame{
    ...
    \begin{itemize}
        ...
        \item Explore reasons for endogenous (or not) election choices.
    \end{itemize}
