...
\frame{
    ...
    {\large{\textbf{Too difficult}}} to time pumping the {\large{\textbf{real}}} economy/budget before {\large{\textbf{endogenous}}} elections (Kayser 2005).
...
\frame{
    ...
    \begin{center}
        The media and {\large{\textbf{voters}}} typically {\large{\textbf{don't observe}}} revisions/don't use revisions in voting decision-making (Kayser and Leininger 2015, Kayser and Peress 2015).
    \end{center}
}
