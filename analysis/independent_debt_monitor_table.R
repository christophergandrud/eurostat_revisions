...
print(
    xtable(out_table, caption = "Start and End Years (if any) of Independent National Debt Rule Monitors", label = 'indep_monitors'),
    caption.placement = 'top', include.rownames = F,
    file = 'working_paper/tables/independent_monitors.tex')
